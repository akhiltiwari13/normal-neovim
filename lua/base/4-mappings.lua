  ...
  maps.n["<leader>ff"] = {
    function()
      require("telescope.builtin").find_files({
        ...
        find_command = { "fd", "--type", "f", "--strip-cwd-prefix" }, -- Use fd for speed
      })
    end,
    desc = "Find all files in project",
  }

  maps.n["<leader>fg"] = { -- 'g' for grep
    function()
    ...
    desc = "Find text in project (all files)",
  }

  maps.n["<leader>fF"] = {
    function()
      require("telescope.builtin").find_files() -- Respects .gitignore, faster
    end,
